...
const SYMPTOM_RULES = [
    ...
    v(
        "pale_color",
        /\b(pale|paler|pallid)\b.*\b(color|colour|crop)|\b(color|colour)\b.*\b(pale|off|faded)\b|\b(turning|becoming)\b.*\b(pale|paler)\b.*\b(slow|slowly|gradual)|\b(faded|fade)\b.*\b(after\s+)?(heat|hot|heat\s+exposure)|\b(heat\s+exposure)\b.*\b(faded|fade|vigor)/i,
    ...
    v(
        "more_fragile",
        /\b(more\s+)?fragile\b|\bfragility\b|\bbrittle\b.*\b(crop|plants?|canopy)\b|\bfragile\b.*\b(lately|recently)|\b(plants?|crop)\b.*\b(feel|feels)\b.*\bfragile\b|\b(fragile|touchy)\b.*\b(during|in)\b.*\b(humid|humidity|humid\s+period)/i,
    ...
    v(
        ...
        /\b(chang(ing)?)\b.*\b(color|colour)\b.*\b(uneven|unevenly|patchy)|\b(uneven)\b.*\b(color|colour)\b.*\b(chang|shift)|\b(patchy)\b.*\b(in\s+)?(color|colour)|\b(leaves?)\b.*\b(becom(ing)?\s+)?patchy\b.*\b(color|colour)/i,
    ...
    v(
        "losing_firmness",
        /\b(los(e|ing)|lost)\b.*\b(firmness)|\b(firmness)\b.*\b(los(e|ing)|reduced)|\b(less\s+firm)\b|\b(los(e|ing)|lost)\b.*\b(firmness)\b.*\b(after\s+)?(humid|humidity)|\b(humid\s+weather)\b.*\b(firmness|turgor)/i,
    ...
    v(
        ...
        /\b(improved|better)\b.*\b(weather)\b.*\b(stabil|calm|evened)|\b(weather)\b.*\b(stabil|calm)\b.*\b(improved|better)|\b(improved|better)\b.*\b(temp|temperatures?)\b.*\b(stabil|normalized|normalised|cooled)|\b(temp|temperatures?)\b.*\b(normalized|normalised)\b.*\b(healthier|better|improved)/i,
    ...
    v(
        ...
        /\b(worsened|worse|weaker)\b.*\b(after\s+)?(irrigation|watering)\b.*\b(chang|timing|adjust)|\b(irrigation|watering)\b.*\b(chang|timing)\b.*\b(worsened|worse|destabil)/i,
    ...
    v(
        ...
        /\b(areas?|zones?|patches?)\b.*\b(recover|bounce)\b.*\b(faster|quicker)\b.*\b(than\s+others)|\b(recover)\b.*\b(quick|fast)\b.*\b(while\s+others|others\s+lag)/i,
    ...
    v(
        ...
        /\b(recover(y|ed|ing)?|improved|better)\b.*\b(after\s+)?(rain|rainfall)\b.*\b(stopped|ended|let\s+up)|\b(rain)\b.*\b(stopped)\b.*\b(recover|drier)/i,
    ...
    v(
        "weaker_after_storms",
        /\b(weaker|worse|stress|feels?\s+weaker)\b.*\b(after\s+)?(storms?|storm|severe\s+weather)|\b(storms?)\b.*\b(weaker|stress|damage)/i,
    ...
    v(
        ...
        /\b(stress|stressed|weaker)\b.*\b(near|by)\b.*\b(compacted)\b.*\b(rows?|soil|areas?)|\b(compacted)\b.*\b(rows?)\b.*\b(stress)/i,
    ...
    v(
        ...
        /\b(lighter|lightening|paler)\b.*\b(leaves?|canopy)\b.*\b(after\s+)?(heavy\s+rain|lots?\s+of\s+rain)|\b(heavy\s+rain)\b.*\b(leaves?)\b.*\b(lighter|paler)/i,
    ...
    v(
        ...
        /\b(unstable|worse|stressed)\b.*\b(irrigation|watering)\b.*\b(delay|delays|gaps)|\b(irrigation)\b.*\b(delay|inconsistent)\b.*\b(stress|unstable)/i,
    ...
    v(
        ...
        /\b(chang|shift)s?\b.*\b(after\s+)?(every\s+)?(weather\s+shift|weather\s+change)|\b(weather)\b.*\b(shift|chang)\b.*\b(every|each)\b/i,
    ...
    v(
        ...
        /\b(improved|better)\b.*\b(drainage)\b.*\b(channels?|ditches?)\b.*\b(cleared|opened)|\b(channels?|ditches?)\b.*\b(cleared)\b.*\b(drainage|field)/i,
    ...
    v(
        ...
        /\b(weaker|worse|low\s+vigor)\b.*\b(repeated|several|many)\b.*\b(cloudy|overcast|gray)\b.*\b(days?)|\b(cloudy)\b.*\b(days?)\b.*\b(weaker|vigor)/i,
    ...
    v(
        ...
        /\b(stressed|stress)\b.*\b(despite|even\s+with)\b.*\b(stable|consistent)\b.*\b(irrigation|watering)/i,
    ...
    v(
        ...
        /\b(react|reacts)\b.*\b(strongly|a\s+lot)\b.*\b(after\s+)?(storms?|severe\s+weather)|\b(storms?)\b.*\b(react|destabil)/i,
    ...
    v(
        ...
        /\b(improved|better)\b.*\b(irrigation|watering)\b.*\b(consistent|steady|regular)|\b(consistent)\b.*\b(irrigation|watering)\b.*\b(improved|helped)/i,
    ...
    v(
        ...
        /\b(thinner|thin)\b.*\b(leaves?)\b.*\b(after\s+)?(repeated|ongoing|prolonged)\b.*\b(stress)/i,
    ...
    v(
        ...
        /\b(some|many)\b.*\b(remain|stay)\b.*\b(healthy|fine|good)\b.*\b(while\s+others|others)\b.*\b(declin|worse|struggl)|\b(healthy)\b.*\b(while\s+others)\b.*\b(declin|worse)/i,
